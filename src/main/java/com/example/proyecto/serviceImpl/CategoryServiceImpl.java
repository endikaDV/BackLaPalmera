...
import com.example.proyecto.dao.CategoryDao;
        ...
        try {
            if (jwtFilter.isAdmin()){
                if (validateCategoryMap(requestMap,false)){
                    ...
                    return CafeUtils.getResponseEntity("Categoria añadida",HttpStatus.OK);
                }
            ...
            if (jwtFilter.isAdmin()){
                if (validateCategoryMap(requestMap,true)){
                    ...
                    if (!optional.isEmpty()){
                        ...
                        return CafeUtils.getResponseEntity("El ID de la categoria no existe", HttpStatus.OK);
                    }
                }
