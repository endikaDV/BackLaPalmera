...
import com.example.proyecto.dao.BillDao;
import com.example.proyecto.jwt.JwtFilter;
import com.example.proyecto.pojo.Bill;
import com.example.proyecto.service.BillService;
...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            return CafeUtils.getResponseEntity("Datos no encontrados", HttpStatus.BAD_REQUEST);
        }catch (Exception ex){
            ex.printStackTrace();
        }
    ...
    private void setRectangleInPdf(Document document) throws DocumentException {
        ...
        Rectangle rect = new Rectangle(77, 825, 18, 15);
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            Bill bill = new Bill();
            bill.setUuidd((String) requestMap.get("uuidd"));
